...
knitr::include_graphics("https://ctbcuatx.edu.mx/wp-content/uploads/2020/07/1617710_1048843451811700_2278987052727773097_o-1920x805.jpg")
```
]]
.pull-right[
...
Ratio
```{r}
r1<-0.03910612 / 0.0110612
r2<-0.07543265 / 0.1110612 
r3<-0.07543264 / 0.03910612
cbind(r1,r2,r3)
```
]
---
...
>- Otras pruebas: Prueba de Levene, Goldfeld-Quand, White, entre otras.
...
---
# t de Student
- Desarrollada por William Sealy Gosset. 

- La prueba t permite comparar las medias de una muestra con la media teórica de una población, o comparar dos poblaciones. 
...
Dónde $t$ es el estadístico, $\bar{x}$ es la media muestral, $s$ es la desviación estándar muestral, y $n$ es el tamaño de la muestra. 
...
En la prueba t de Student para medidas repetidas se usa la siguiente fórmula:

$$t=\frac{\bar{x}_{d}-\mu_{d}}{s_{d}/\sqrt{n}}$$
Dónde $t$ es el estadístico, $\bar{x_{d}}$ es la media muestral de la diferencia de las medidas, $s_{d}$ es la desviación estándar muestral, y $n_{d}$ es el tamaño de la muestra. 
...
- Debemos tener en cuenta si hay dependencia o no de los grupos y si la varianza es igual.
...
| - Se pueden usar vaiables ordinales     |- Poder estadísitico menor   | 
...
background-image: url(https://scontent.fpbc4-1.fna.fbcdn.net/v/t1.6435-9/186488007_894978351283481_2834840846317438655_n.png?_nc_cat=107&ccb=1-7&_nc_sid=730e14&_nc_eui2=AeEgLiV7cxpEnMLIQaq-cj7-BNxQhs6jc4IE3FCGzqNzgqzp65iawk_RfS8gP_fuq9oRHT2NkEMpPVmlmtpXhq6d&_nc_ohc=R-mekgfZ-BEAX8tFsX1&_nc_ht=scontent.fpbc4-1.fna&oh=00_AfCrVhrIj1fpV8p1QRwGOqDrJaFFbpJp-sI4k9xDPR5jLA&oe=6418CE99)
