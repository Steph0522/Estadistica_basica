...
---
### Prueba de Duncan
- Ordenar las medias de la más grande a la más pequeña.
- Cacular el valor crítico *q*, aquí denominad como $r$, como las pruebas anteriores
- Encontrar el valor crítico en la tabla de valores críticos con los $k$ y los grados de libertad del error. 
- Calcular el valor crítico de Duncan, denotado por:
...
- Este $r$ (antes $q_{crítico}$) es variable como anteriormente vimos en la prueba de Newman-Keuls y las diferencias de los promedios:
  - Si las dos primeras medias no son diferentes entonces para la prueba
- En cada comparación de medias corrige los grados de libertad según el número de grupos comparados.
---
### Prueba de Duncan
