...
siendo $k$ los niveles y $N-k$ los grados de libertad y $SC$ la suma de cuadrados. 
---
...
- Hay cinco observaciones en cada grupo entonces = (4*5)-3 = 16
- Los grados de libertad totales son 20-1 = 19
...
4. Encontrar el valor crítico en la tabla de valores críticos con los $k$ y los grados de libertad del error. 
5. Calcular el valor crítico de Duncan, denotado por:
